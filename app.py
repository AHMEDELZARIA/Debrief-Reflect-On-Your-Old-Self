...
def second_window():
    ...
    # Prompt label
    prompt_label= Label(window_2, text = random.choice(prompts), font = ('Magneto', 10, 'bold'), fg = "white", bg= "#745e4d", relief = RAISED, bd = 5, padx = 5, pady= 10) 
    prompt_label.pack()
    
    # Record button
    button2 = Button(window_2, text = "Record", font = ("Magneto", 20, "bold"), fg = "red", bg = "#745e4d", relief = RAISED, bd = 5, padx = 2, pady= 10, command = rec_vid)
    button2.place(x = 150, y = 500)

    # Exit application button
    button3 = Button(window_2, text = "Exit", font = ("Magneto", 20, "bold"), fg = "Blue", bg = "#745e4d", relief = RAISED, bd = 5, padx = 2, pady= 10, command = exit_program)
...
button = Button(window, text = "Press for Daily Prompt", font = ("Comic Sans", 30, "bold"), fg = "#745e4d", bg = "#745e4d", activeforeground = "#745e4d", activebackground= "black", command = second_window)
button.pack()
